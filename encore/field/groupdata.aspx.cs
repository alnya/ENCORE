...
public partial class group_listdata : System.Web.UI.Page
{
    ...
    private string GetPagedContent()
    {
        ...
        {
            var q = from u in ctx.FIELDGROUPs select u;
            ...
            {
                var fgRow = new FlexigridRow {id = result.ID, cell = new List<string> {result.NAME, result.NAME}};
