<%@ Page Title="User Details" Language="C#" MasterPageFile="~/master/twocolumn.master" AutoEventWireup="true" Inherits="user_detail" Codebehind="detail.aspx.cs" %>
                ...
                <fieldset class="panel dataentry">
                    <div class="dataentryrow">
                        <encore:TextBox ID="txtEmailAddress" FieldSize="Medium" DataType="EmailAddress" Required="true" runat="server" Label="Email Address:" 
                            ...
                            HelpText="This email address will be used to log into the site and for all communication.  It must be unique." />
                    </div>
                    <div class="dataentryrow">
                        <encore:TextBox ID="txtPassword" FieldSize="Medium" Required="false" runat="server" Label="Password:" 
                        TextMode="Password"  
                        HelpTitle="User Password" 
                        HelpText="Entering a password here will change the users login password." />
                    </div>
                    <div class="dataentryrow">
                         <encore:TextBox ID="txtName" FieldSize="Medium" Required="true" runat="server" Label="Name:"   />
                    </div>
                    <div class="dataentryrow">
                         <encore:Select ID="ddlAdministrator" runat="server" 
                             Label="User is Administrator:"
                            HelpTitle="Administrator"
                            HelpText="Administrators can add / delete other users and register projects" />
                    </div>
                </fieldset> 
            </jquery:jTab>
