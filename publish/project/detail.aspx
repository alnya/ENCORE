<%@ Page Title="" Language="C#" MasterPageFile="~/master/twocolumn.master" AutoEventWireup="true" Inherits="project_detail" Codebehind="detail.aspx.cs" %>
            ...
            <jquery:jTab ID="tab1" runat="server" Title="Details">
                <fieldset class="panel dataentry">
                    <div class="dataentryrow">
                        <encore:TextBox ID="txtName" FieldSize="Medium" Required="true" runat="server" Label="Project Name:"
                    ...
                    <div class="dataentryrow">
                     ...
                     <div class="dataentryrow">
                        <encore:TextBox ID="txtURL" FieldSize="Medium" runat="server" Label="Project URL:"
                        HelpTitle="Project URL"
                        HelpText="This is the URL of the project to load (e.g. 'http://nitroeuropedata.ceh.ac.uk/encore/encore.asmx')"  />
